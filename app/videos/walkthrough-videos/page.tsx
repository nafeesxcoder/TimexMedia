...
export default function WalkthroughVideosPage() {
  const video = getVideoBySlug("walkthrough-videos")!;
  ...
  const placeholderGallery = [
    ...
    { id: 4, title: "Downtown Condo", duration: "2:45" },
    { id: 5, title: "Suburban Family Home", duration: "3:00" },
    { id: 6, title: "Commercial Space", duration: "2:30" },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            {video.stats.map((stat, i) => (
              ...
              >
                <div className="text-center p-6 rounded-2xl border border-white/10 bg-black/30">
                  <div className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
                    {stat.value}
                  </div>
          ...
          <AnimateOnView animation="fade-in-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {video.highlights.map((highlight, i) => (
                ...
                >
                  <FiCheckCircle className="w-5 h-5 text-blue-500 mt-0.5 shrink-0" />
        ...
        <div className="max-w-7xl mx-auto">
          <AnimateOnView animation="fade-in-up">
            ...
            <p className="text-gray-400 text-center mb-12">
              Our walkthrough video portfolio - Coming soon
            </p>
          </AnimateOnView>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {placeholderGallery.map((item, i) => (
              <AnimateOnView
                ...
                delay={`${0.05 * i}s`}
              >
                <div className="group relative overflow-hidden rounded-xl border border-white/10 bg-black/40 hover:border-blue-500/50 transition-all duration-300 hover:scale-[1.02]">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/20 via-transparent to-purple-900/20">
        <div className="max-w-4xl mx-auto text-center">
          <AnimateOnView animation="float-in">
            ...
            <Link
              href="/book-now"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg rounded-lg hover:opacity-90 transition gap-2"
            >
