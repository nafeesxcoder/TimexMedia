...
const PortfolioPreview = () => {
  ...
  // State to track slider position for each image
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
          {imageNumbers.map((num, i) => (
            <AnimateOnView
              ...
              className="relative"
            >
              <div className="relative aspect-[16/10] overflow-hidden rounded-xl bg-gray-900 shadow-lg">
                {/* Slider Container */}
                <div
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        ...
                        style={{
                          filter:
                            "blur(25px) brightness(0.15) contrast(0.2) saturate(0) grayscale(1)",
                          opacity: 0.8,
                        }}
                      />
                      <div className="absolute inset-0 bg-gradient-to-br from-black/70 to-transparent"></div>
                    </div>
                  </div>
