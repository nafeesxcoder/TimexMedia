...
export const SERVICES: ServiceItem[] = [
  {
    ...
    heroImage: "",
    videoId: "aqz-KE-bpKQ",
    intro: "High-impact listing photos are the first thing buyers see. We shoot every angle with the right light and composition so your listings look their best and stand out in search results and on social.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    intro: "Video tours and lifestyle clips give buyers a real feel for the property. We produce smooth walkthroughs, drone footage, and short hero clips tailored for listing pages, social, and ads.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "aqz-KE-bpKQ",
    intro: "Stand out on Instagram, TikTok, and Facebook with content built for real estate. We create reels, stories, and feed posts that highlight listings, tips, and your personal brand so you stay top of mind.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "ScMzIvxBSi4",
    intro: "Let buyers walk through the property online with immersive 3D tours. We capture and build Matterport-style experiences so out-of-area buyers and busy clients can explore every room on any device.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "aqz-KE-bpKQ",
    intro: "Clear floor plans help buyers visualize layout and square footage. We deliver accurate 2D plans with room labels and dimensions, styled for MLS, brochures, and digital marketing.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "ScMzIvxBSi4",
    intro: "Empty or under-furnished rooms can feel cold online. We add realistic furniture and decor so buyers see the potential of each space without a single piece of physical staging.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "aqz-KE-bpKQ",
    intro: "Your face is your brand. We shoot headshots that look sharp on business cards, websites, and social—so you present a consistent, professional image everywhere you show up.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    videoId: "ScMzIvxBSi4",
    videoId2: "aqz-KE-bpKQ",
    intro: "Build a library of on-brand photos and short videos for your website, social, and ads. We plan shots around your style and message so you have a go-to set of assets that feel authentically you.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    intro: "Raw footage becomes scroll-stopping reels when the edit is right. We cut for hooks, pacing, and platform trends so your real estate content has a real shot at going viral and driving leads.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    heroImage: "",
    videoId: "aqz-KE-bpKQ",
    intro: "Stay visible without spending your day on social. We handle content planning, posting, and engagement so your feeds stay active and on-brand while you focus on listings and clients.",
    contentBlocks: [
      {
